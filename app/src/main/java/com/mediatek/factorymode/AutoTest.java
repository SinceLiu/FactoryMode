...
public class AutoTest extends TestActivity {
...
//        System.gc();
        ...
        // Intent.FLAG_ACTIVITY_NEW_TASK); //bob.chen disabled
        int requestid = -1;
        if (requestCode == AppDefine.FT_BATTERYID) {
            ...
            intent.setClassName(this, "com.mediatek.factorymode.keycode.KeyCode");
...
//            intent.setClassName(this, "com.mediatek.factorymode.touchscreen.LineTest");
            intent.setClassName(this, "com.mediatek.factorymode.touchscreen.NewTouchScreen");
            // intent.setClassName(this,
            // "com.mediatek.factorymode.touchscreen.TouchScreen");
        ...
        if (requestCode == AppDefine.FT_BACKLIGHTID) {
            intent.setClassName(this, "com.mediatek.factorymode.simsdcard.SimCardPre");
        ...
        if (requestCode == AppDefine.FT_AUDIOID) {
            intent.setClassName(this, "com.mediatek.factorymode.hall.Hall");
            requestid = AppDefine.FT_HALLID;
        }
        if (requestCode == AppDefine.FT_HALLID) {
        ...
        if (!FactoryModeFeatureOption.CENON_FACTORY_BACKTOUCH) { // skip
                                                                 // backtouch
        ...
        if (requestCode == AppDefine.FT_BACKTOUCH) {
            intent.setClassName(this, "com.mediatek.factorymode.kpdLed.KpdLed");
            requestid = AppDefine.FT_KPDID;
        }
