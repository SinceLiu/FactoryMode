...
public class TsMultiTouch extends TestActivity {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            if (input.getText() != null
                                ...
                                preferences.edit().putInt("size",
                                        TsMultiTouch.this.mPointSize).apply();

                                mView.invalidate();
                            }
//                            else {
//                                Log.w(TAG, "DIALOG edit null");
//                            }
                        }
...
//                    Log.i(TAG, " mInputIds.get(pid).size() = " +  mInputIds.get(pid).size());
                    if (i < mInputIds.size()) {
